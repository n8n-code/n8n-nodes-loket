...
export const administrationDescription: INodeProperties[] = [
			...
			"options": [
				{
					"name": "Get Administrations By Employer ID",
					"value": "Get Administrations By Employer ID",
					"action": "List of administrations for an employer",
					...
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/providers/employers/{{$parameter[\"employerId\"]}}/administrations"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /providers/employers/{employerId}/administrations",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Get Administrations By Employer ID"
					]
				}
			}
		},
