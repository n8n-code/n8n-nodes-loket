...
export const employmentNotesDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Delete Employment Note By Note ID",
					"value": "Delete Employment Note By Note ID",
					"action": "Delete an employment note record",
					"description": "__Activity name :__ DeleteEmploymentNoteByNoteId\n\nDelete an existing note record\n",
					"routing": {
						"request": {
							"method": "DELETE",
							"url": "=/providers/employers/employees/employments/notes/{{$parameter[\"noteId\"]}}"
						}
					}
				},
				{
					"name": "Get Employment Note By Note ID",
					"value": "Get Employment Note By Note ID",
					"action": "Details of an employment note",
				...
				{
					"name": "Put Employment Note By Note ID",
					"value": "Put Employment Note By Note ID",
					"action": "Edit an employment note record",
				...
				{
					"name": "Get Employment Notes By Employment ID",
					"value": "Get Employment Notes By Employment ID",
					"action": "Get a list of notes for an employment.",
					...
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/providers/employers/employees/employments/{{$parameter[\"employmentId\"]}}/notes"
						}
					}
				},
				{
					"name": "Post Employment Note By Employment ID",
					"value": "Post Employment Note By Employment ID",
					"action": "Add a note for an employment",
		...
		{
			"displayName": "DELETE /providers/employers/employees/employments/notes/{noteId}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Delete Employment Note By Note ID"
					]
				}
			}
		},
		...
		{
			"displayName": "GET /providers/employers/employees/employments/notes/{noteId}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Get Employment Note By Note ID"
					]
				}
			}
		},
		...
		{
			"displayName": "PUT /providers/employers/employees/employments/notes/{noteId}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Put Employment Note By Note ID"
					]
				}
			}
		},
		...
		{
			"displayName": "GET /providers/employers/employees/employments/{employmentId}/notes",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Get Employment Notes By Employment ID"
					]
				}
			}
		},
		...
		{
			"displayName": "POST /providers/employers/employees/employments/{employmentId}/notes",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Post Employment Note By Employment ID"
					]
				}
			}
		},
